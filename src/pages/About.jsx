        ...
        <>
            ...
            <div className="w-full bg-gray-100 py-12">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="
                        bg-white shadow-xl rounded-xl border-4 border-blue-600 overflow-hidden
                        transition-all duration-300 hover:shadow-blue-400 hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.02]
                    ">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-10 flex flex-col justify-center bg-white">
                                ...
                                <p className="text-gray-700 leading-relaxed text-lg text-justify">
                                    MDCCB had been recognized by merging the said Co-operative Banks
                                    in the year 1959. It is registered under the West Bengal
                                    Co-operative Societies Act being the Registration No. 38/59
                                    dated 25-07-1959. The main focus of the bank was to provide
                                    advance on agriculture and allied activities.
                                    <br /><br />
                                    In 1992-93, the Indian Economy changed drastically. The bank
                                    adopted diversified loans like Cash Credit, Work Order, ECCS,
                                    Personal Loan, and Project Loan along with agricultural loan.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 mt-16">
                    <div className="
                        bg-white shadow-xl rounded-xl border-4 border-blue-500 overflow-hidden
                        transition-all duration-300 hover:shadow-blue-400 hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.02]
                    ">
                        <div className="grid grid-cols-1 md:grid-cols-2 md:flex-row-reverse">
                            ...
                            <div className="p-10 flex flex-col justify-center bg-white">
                                ...
                                <p className="text-gray-700 leading-relaxed text-lg text-justify">
                                    About 72-76% populations depend on agriculture and allied
                                    activities. Most of them are poor, small & marginal farmers.
                                    Before independence, 4 Co-operative Banks operated under each
                                    Sub-Division.
                                    <br /><br />
                                    Their main focus was agricultural lending exclusively to members.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 mt-16">
                    <div className="
                        bg-white shadow-lg rounded-xl border border-blue-300 p-10
                        transition-all duration-300 hover:shadow-blue-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02]
                    ">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg text-justify">
                            ...
                            Bhagirathi, Jalangi and others. Agriculture remains the backbone
                            of the local economy with 26 blocks under operation.
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 mt-16 mb-20">
                    ...
                    ">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg text-justify">
                            The bank is licensed by the RBI under Section 22. The bank has also
                            implemented Core Banking Solutions and now operates 22 CBS-enabled
                            branches.
                        </p>
                    </div>
                </div>
